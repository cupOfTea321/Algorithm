...
const MainServices = ({logo = true, servicesPage = false}) => {
    ...
    const services = [
        {text: t("storage"), img: serv1, link: 'storage'},
        {text: t("transportation"), img: serv2, link: 'transportation'},
        {text: t("registration"), img: serv3, link: 'registration'},
        {text: t("shipment"), img: serv4, link: 'shipment'},
    ]
    return (
        <Container maxWidth="md">
            <Box sx={{
                ...
                {
                    logo && <Typography variant={'h3'} className={'oswFont'} sx={{
                        display: 'flex',
